		...
		try {
			...
			switch (sqlFunction) {
				...
				case MYSQL.SET.RECEIPT.SAVE_DOCREC: {
					...
					const arrValues = [
						String(parameters[MENU.DIALOG.DOCREC.SHOW_REC['storeId']]),
						String(parameters[MENU.DIALOG.DOCREC.SHOW_REC['total']]),
						String(parameters[MENU.DIALOG.DOCREC.SHOW_REC['datetime']]),
						String(parameters[MENU.DIALOG.DOCREC.TYPE._]),
