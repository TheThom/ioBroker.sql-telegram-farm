			...
			switch (sqlFunction) {
				...
				case MYSQL.SET.RECEIPT.SAVE_DOCREC: {
					...
					const arrValues = [
						...
						String(parameters[MENU.DIALOG.DOCREC.SHOW_REC._]['total']),
					...
					if (result.warningStatus == '') {
						...
						if (result.warningStatus == '') {
							...
							await this.sendTextToUser(user, 'MYSQL.SET.RECEIPT.SAVE_DOCREC: invalid result:');
							await this.sendTextToUser(user, result.warningStatus);
						}
					}
					return false;
				}
