							...
							contents: [
								{
									...
									parts: [
										{
											text: 'Gib den Kassenbeleg in JSON aus. Der Preis bezieht sich auf Stückzahl 1. Felder: store_name, address[street, housenumber, city, postcode], items[name, price, item_id, quantity], total, datetime im Format YYYY-MM-DD hh:mm:ss',
										},
										{
											inlineData: {
												data: base64Data,
