			...
			switch (type) {
				case MENU.DIALOG.DOCREC.TYPE.DEBUG: {
					...
					try {
							...
							contents: [
								{
									...
									parts: [
										{
											text: 'Gib den Kassenbeleg in JSON aus. Felder: store_name, address[street, housenumber, city, postcode], items[name, price, item_id], total, datetime',
										},
										{
											inlineData: {
												data: base64Data,
						...
						await this.sendTextToUser('Fehler bei der Belegerfassung');
					}
