...
const genAI = new GoogleGenAI({ apiKey: 'AIzaSyDm7VjLcmSY4ZRMfDZqdKn0ysClzKknBVQ' });
				...
				case MENU.DIALOG.DOCREC.TYPE.RECEIPT: {
					...
					try {
						...
						const result = await genAI.models.generateContent({
							...
							model: 'gemini-1.5-pro', // Aktuellstes Modell
							contents: [
								{
									role: 'user',
									parts: [
										{
											text: 'Gib den Kassenbeleg in JSON aus. Felder: store_name, address[street, housenumber, city, postcode], items[name, price, item_id, quantity], total, datetime im Format YYYY-MM-DD hh:mm:ss',
										},
										{
											inlineData: {
												data: base64Data,
